...
#'
#' Trasforma i metadati genomici dei geni RP in un oggetto GenomicRanges.
...
#' Setup File ATAC
#'
#' Gestisce la decompressione, compressione bgzip e indicizzazione tabix.
...
#'
#' Genera tabella di contingenza tra Cluster e orig.ident.
